...
def usage():
    print
    'Saphyra Priv8 Hax Stroke iDDoS Tool ( individual Dangerous Denial of Service )'
    print
    'Hax Stroke Facebook: http://facebook.com/anonghostsoldierstroke'
    print
...
if len(sys.argv) < 2:
    ...
    if sys.argv[1] == "help":
        ...
        print
        "Starting the Saphyra shotings in webserver Hyper Massive Revolt DDoS Tool"
        print
        "Created By Hax Stroke"
        if len(sys.argv) == 3:
            if sys.argv[2] == "safe":
